...
func (_m *ServerRepo) Create(ctx context.Context, server *persistence.Server) error {
...
func (_m *ServerRepo) GetByID(ctx context.Context, id string) (*persistence.Server, error) {
...
func (_m *ServerRepo) List(ctx context.Context, region string, status string, typ string, limit int, offset int) ([]*persistence.Server, error) {
...
func (_m *ServerRepo) UpdateBilling(ctx context.Context, id string, accumulatedSeconds int64, totalCost float64) error {
...
func (_m *ServerRepo) UpdateServer(ctx context.Context, id string, updates *persistence.Server) error {
...
func (_m *ServerRepo) UpdateState(ctx context.Context, id string, state string) error {
...
func (_m *ServerRepo) UpdateTimestamps(ctx context.Context, id string, started *time.Time, stopped *time.Time, terminated *time.Time) error {
...
// NewServerRepo creates a new instance of ServerRepo. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewServerRepo(t interface {
	mock.TestingT
	Cleanup(func())
}) *ServerRepo {
	mock := &ServerRepo{}
