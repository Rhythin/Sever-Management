...
// IPRepo is an autogenerated mock type for the IPRepo type
type IPRepo struct {
	mock.Mock
}

// AllocateIP provides a mock function with given fields: ctx
func (_m *IPRepo) AllocateIP(ctx context.Context) (*persistence.IPAddress, error) {
	ret := _m.Called(ctx)
...
func (_m *IPRepo) AssignIPToServer(ctx context.Context, ipID uint, serverID string) error {
...
func (_m *IPRepo) ReleaseIP(ctx context.Context, id uint) error {
...
// NewIPRepo creates a new instance of IPRepo. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIPRepo(t interface {
	mock.TestingT
	Cleanup(func())
}) *IPRepo {
	mock := &IPRepo{}
