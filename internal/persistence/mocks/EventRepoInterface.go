...
// EventRepoInterface is an autogenerated mock type for the EventRepoInterface type
type EventRepoInterface struct {
	mock.Mock
}

// Append provides a mock function with given fields: ctx, event
func (_m *EventRepoInterface) Append(ctx context.Context, event *persistence.EventLog) error {
...
func (_m *EventRepoInterface) LastN(ctx context.Context, serverID string, n int) ([]persistence.EventLog, error) {
...
// NewEventRepoInterface creates a new instance of EventRepoInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewEventRepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *EventRepoInterface {
	mock := &EventRepoInterface{}
	mock.Mock.Test(t)
